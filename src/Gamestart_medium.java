...
public class Gamestart_medium extends JPanel {
    ...
    Rectangle2D getbound(){
        return (new Rectangle2D.Double(basket_x,550,45,45));
    }
    public void paintComponent(Graphics g) {
        ...
        if(time<=0||HP<=0){
            ...
            for(int i=0 ; i<f1p.size();i++){
                g.drawImage( f1p.get(i).getImage() ,f1p.get(i).getX(),f1p.get(i).getY(),90,90,this);
            }
            for(int i=0 ; i<f1p.size();i++){
            ...
            for(int i=0 ; i<f2p.size();i++){
                g.drawImage( f2p.get(i).getImage() ,f2p.get(i).getX(),f2p.get(i).getY(),90,90,this);
            }
            for(int i=0 ; i<f2p.size();i++){
            ...
            for(int i=0 ; i<f3p.size();i++){
                g.drawImage( f3p.get(i).getImage() ,f3p.get(i).getX(),f3p.get(i).getY(),90,90,this);
            }
            for(int i=0 ; i<f3p.size();i++){
            ...
            for(int i=0 ; i<f4p.size();i++){
                g.drawImage( f4p.get(i).getImage() ,f4p.get(i).getX(),f4p.get(i).getY(),90,90,this);
            }
            for(int i=0 ; i<f4p.size();i++){
